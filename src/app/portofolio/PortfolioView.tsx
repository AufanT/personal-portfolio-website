...
export default function PortfolioView({ initialProjects }: PortfolioViewProps) {
  // Data sudah diambil di server oleh page.tsx, jadi tidak ada lagi state
  // loading maupun fetch dari browser seperti pada versi Supabase.
