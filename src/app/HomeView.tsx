...
export default function HomeView({ featuredProjects }: HomeViewProps) {
  // Project unggulan sekarang diambil di server oleh page.tsx — dulu di-fetch
  // dari browser lewat Supabase, yang bikin panel sempat kosong saat load.
